...
const Landing = () => {
  return <div className="landing">
    ...
    <div 
      ...
      <h5 className="description landing-text">We allow more space and freedom for the unique ways in which <u>you</u> learn.</h5>
      <br></br>
      <h5 
      id="tagline" 
      className="landing-text description">Our name is inspired by the word</h5>
      <h5 
      id="tagline" 
      className="landing-text description">lu•cu•brate &nbsp;&nbsp;/&nbsp;&nbsp; to write or study (especially by night)</h5>
    </div>
    <LandingBackground />
  </div>
}
